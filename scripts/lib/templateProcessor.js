...
class TemplateProcessor {
    ...
    createTemplateMapping(config) {
        return {
            ...
            'Frontend Framework': config.techStack.frontend || 'Not specified',
            'Backend Framework': config.techStack.backend || 'Not specified',
            Database: config.techStack.database || 'Not specified',
